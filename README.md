...
This puts all the data into syslog, you can query this however you like, `gnuplot` or `splunk`, or whatever tool you prefer.

I use a dashboard in splunk, with a query like this:
